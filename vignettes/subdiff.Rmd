...
Installation of **subdiff** requires several other package not currently available on CRAN:
...
Other helpful package, some of which are required to run the code in this tutorial:
...
```{r, eval = FALSE}
pkgs <- file.path("mlysy", c("optimCheck", "mniw", "LMN", "subdiff"))
