...
```{r dataset, child = "subdiff_child/_dataset.Rmd"}
```

```{r semiparam, child = "subdiff_child/_semiparametric.Rmd"}
```

```{r param, child = "subdiff_child/_parametric.Rmd"}
```

```{r csiclass, child = "subdiff_child/_csiclass.Rmd"}
```
